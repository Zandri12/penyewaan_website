    ...
    <div id="logoAndNav" class="main-header-menu-wrap bg-transparent fixed-top">
        <div class="container">
            <nav class="js-mega-menu navbar navbar-expand-md header-nav">
                ...
                <!--logo start-->
                <a class="navbar-brand" href="index.html"><img src="{{ asset ('assets/img/logo-white.png')}}" width="120" alt="logo" class="img-fluid" /></a>
                <!--logo end-->
                                    ...
                                    <div class="col-lg-7 col-sm-6 col-12 custom-radius-right">
                                        <div class="row no-gutters p-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-1-color.png')}}" width="85" class="img-fluid" alt="client" />
                                                        <small class="u-header__promo-text">Product Landing Page Template</small>
                                                    </a>
                                                </div>
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-2-color.png')}}" width="85" class="img-fluid" alt="client" />
                                                        <small class="u-header__promo-text">Corporate Business & Agency Template</small>
                                                    </a>
                                                </div>
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-6-color.png')}}" width="85" class="img-fluid" alt="client" />
                                            ...
                                            <div class="col-md-6">
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-3-color.png')}}" width="85" class="img-fluid" alt="client" />
                                                        <small class="u-header__promo-text">App Landing Page Template</small>
                                                    </a>
                                                </div>
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-4-color.png')}}" width="85" class="img-fluid" alt="client" />
                                                        <small class="u-header__promo-text">Corporate Business Template</small>
                                                    </a>
                                                </div>
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="#">
                                                        <img src="{{ asset ('assets/img/client-5-color.png')}}" width="85" class="img-fluid" alt="client" />
                            ...
                            <div class="hs-mega-menu main-sub-menu" style="width: 320px" aria-labelledby="aboutMegaMenu">
                                ...
                                <div class="title-with-icon-item">
                                    <a class="title-with-icon-link" href="contact-us.html">
                                        <div class="media align-items-center">
                                            <img class="menu-titile-icon" src="{{ asset ('assets/img/chat-mob')}}ile.svg" alt="SVG">
                                            <div class="media-body">
                                ...
                                <div class="title-with-icon-item">
                                    <a class="title-with-icon-link" href="about-us.html">
                                        <div class="media align-items-center">
                                            <img class="menu-titile-icon" src="{{ asset ('assets/img/communit')}}y.svg" alt="SVG">
                                            <div class="media-body">
                                ...
                                <div class="title-with-icon-item">
                                    <a class="title-with-icon-link" href="partners.html">
                                        <div class="media align-items-center">
                                            <img class="menu-titile-icon" src="{{ asset ('assets/img/partner.')}}svg" alt="SVG">
                                            <div class="media-body">
                                ...
                                <div class="title-with-icon-item">
                                    <a class="title-with-icon-link" href="network.html">
                                        <div class="media align-items-center">
                                            <img class="menu-titile-icon" src="{{ asset ('assets/img/network.')}}svg" alt="SVG">
                                            <div class="media-body">
                                ...
                                <div class="title-with-icon-item">
                                    <a class="title-with-icon-link" href="blog-grid.html">
                                        <div class="media align-items-center">
                                            <img class="menu-titile-icon" src="{{ asset ('assets/img/blog.svg')}}" alt="SVG">
                                            <div class="media-body">
